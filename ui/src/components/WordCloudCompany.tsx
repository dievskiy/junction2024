...
interface WordCloudCompanyProps {
  words: WordData[];
}

const WordCloudCompany: React.FC<WordCloudCompanyProps> = ({ words }) => {
    ...
    <div className="bg-white rounded-xl shadow-lg p-6">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-semibold flex items-center">
          ...
          How your company present itself
        </h2>
...
export default WordCloudCompany;
